...
lights = b.lights
#lights = []
#lights.append( lights_all[4])
#lights.append( lights_all[5])
...
def candle_flicker():
    ...
    '''
    b.set_light(select_multiple_lights(),
                {'transitiontime': multi_modal(), 'on': True, 'bri': 1 + int(random.betavariate(2, 5) * 253),
